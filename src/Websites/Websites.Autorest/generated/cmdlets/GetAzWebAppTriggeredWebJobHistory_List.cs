...
namespace Microsoft.Azure.PowerShell.Cmdlets.Websites.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ListTriggeredWebJobHistory=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/triggeredwebjobs/{webJobName}/history"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzWebAppTriggeredWebJobHistory_List")]
    ...
    public partial class GetAzWebAppTriggeredWebJobHistory_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Websites.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzWebAppTriggeredWebJobHistory_List" /> cmdlet class.
        /// </summary>
        public GetAzWebAppTriggeredWebJobHistory_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.WebAppsListTriggeredWebJobHistory(ResourceGroupName, AppName, Name, SubscriptionId, onOk, onNotFound, onDefault, this, Pipeline);
                ...
                if (_isFirst)
                {
                    ...
                    while (_nextLink != null)
                    {
                        if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                        {
                            ...
                            await this.Client.WebAppsListTriggeredWebJobHistory_Call(requestMessage, onOk, onNotFound, onDefault, this, Pipeline);
                        }
                    }
                }
            }
