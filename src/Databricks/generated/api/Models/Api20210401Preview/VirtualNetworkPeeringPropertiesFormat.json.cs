...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview
{
    ...
    public partial class VirtualNetworkPeeringPropertiesFormat
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IVirtualNetworkPeeringPropertiesFormat.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IVirtualNetworkPeeringPropertiesFormat.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IVirtualNetworkPeeringPropertiesFormat FromJson(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonNode node)
        {
        ...
        internal VirtualNetworkPeeringPropertiesFormat(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject json)
        {
            ...
            {_databricksVirtualNetwork = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("databricksVirtualNetwork"), out var __jsonDatabricksVirtualNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetwork.FromJson(__jsonDatabricksVirtualNetwork) : DatabricksVirtualNetwork;}
            {_databricksAddressSpace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("databricksAddressSpace"), out var __jsonDatabricksAddressSpace) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.AddressSpace.FromJson(__jsonDatabricksAddressSpace) : DatabricksAddressSpace;}
            {_remoteVirtualNetwork = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("remoteVirtualNetwork"), out var __jsonRemoteVirtualNetwork) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetwork.FromJson(__jsonRemoteVirtualNetwork) : RemoteVirtualNetwork;}
            {_remoteAddressSpace = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Json.JsonObject>("remoteAddressSpace"), out var __jsonRemoteAddressSpace) ? Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.AddressSpace.FromJson(__jsonRemoteAddressSpace) : RemoteAddressSpace;}
